    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('junior_SWE', 'Junior SWE'), ('senior_SWE', 'Senior SWE'), ('intern_SWE', 'Intern SWE')], max_length=20)),
                ('cv', models.FileField(blank=True, null=True, upload_to=Applicants.models.cv_path)),
